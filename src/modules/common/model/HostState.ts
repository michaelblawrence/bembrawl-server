...
export class HostState implements IKeepAlive {
    private lastKeepAliveDtMs: number;
    private gameGuid: string;
    public readonly createdAtDtMs: number;
    
    constructor(public readonly deviceId: string, public readonly sessionId: string, private readonly dateTimeProvider: DateTimeProvider) {
